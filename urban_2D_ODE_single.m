%Parameters 
Dw=1.5;%1.9928608732968183 <- this separates between super (below) and sub (above)
Dv=Dw;
ubar=0.5;
alpha=0.05;
...
ss=sqrt(-eps*U1/(U2+U3)); %steady state
P0=0.012; %initial magnitude
...
%plotting rms. Note you need to solve the single PDE first to obtain
%rmsu1. repeat and save RMS to plot results for multiple initial
%conditions.
figure()
hold on
plot(t,UweakS,'k','LineWidth',2)
%plot(linspace(0,Tmax,Tmax+1),rmsu1,'r-o','MarkerFaceColor','r','MarkerIndices',1:2000:length(rmsu1))
xlabel('t')
ylabel('A_{amp}(t)')
hold off
